...
sap.ui.define([
	...
	* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade
	* @extends sap.ui.base.Object
	* @public
	*/
	return UI5Object.extend("cross.fnd.fiori.inbox.util.tools.ApplicationFacade", {
		...
		* @public
		* @function
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#getResourceBundle
		* @memberOf cross.fnd.fiori.inbox.util.tools.ApplicationFacade
		*/
		...
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#getODataModel
		* @function
		*/
		...
		*          parameter
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#isMock
		* @function
		*/
		isMock : function () {
		...
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#setApplicationModel
		* @function
		*/
		...
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#getApplicationModel
		* @function
		*/
		...
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#getUiLibResourceModel
		* @returns {object} the language model
		* @function
		*/
		...
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#registerOnMasterListRefresh
		* @function
		*/
		registerOnMasterListRefresh : function (fHandler, oListener) {
			return this.oApplicationImplementation.attachEvent("_OnMasterListRefresh", fHandler, oListener);
		},
		...
		* @param {object} oListener is the object that provides the handler function
		* @public
		* @name cross.fnd.fiori.inbox.util.tools.ApplicationFacade#deRegisterOnMasterListRefresh
		* @function
		*/
		deRegisterOnMasterListRefresh : function (fHandler, oListener) {
			return this.oApplicationImplementation.detachEvent("_OnMasterListRefresh", fHandler, oListener);
		}
	});
});
