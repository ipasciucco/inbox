		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#crossfndfioriinbox-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crossfndfioriinbox-display": {
								"semanticObject": "crossfndfioriinbox",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cross.fnd.fiori.inbox",
									"url": sap.ui.require.toUrl("cross/fnd/fiori/inbox")
								}
							}
						}
					}
