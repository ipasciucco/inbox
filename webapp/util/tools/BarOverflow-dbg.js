...
sap.ui.define([
	...
	var BarOverflow = fnUi5Object.extend("cross.fnd.fiori.inbox.util.tools.BarOverflow", {
		...
		_moveControlsToOverflow : function (iBarWidth) {
			...
			// if there are no buttons to move to overflow close the action sheet if it is open
			else if (this._oActionSheet.isOpen()) {
